...
describe('arrange.mjs deletePrivatePath()', () => {
    ...
    it('Es wird die API DELETE /api/files/test_user_id/ mit dem gegebenen Pfad aufgerufen.', async () => {
        ...
        await arrange.deletePrivatePath('path/to/private/file')
